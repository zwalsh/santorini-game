...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "jsons$ebnf$1", "symbols": []},
    {"name": "jsons$ebnf$1$subexpression$1", "symbols": ["_", "json"]},
    {"name": "jsons$ebnf$1", "symbols": ["jsons$ebnf$1", "jsons$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "jsons", "symbols": ["_", "json", "jsons$ebnf$1", "_"], "postprocess": extractJsons},
